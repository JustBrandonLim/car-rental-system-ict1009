...
CustomerAccount::CustomerAccount(CarManager* carManager, RentalManager* rentalManager, std::string username, std::string password, std::string name, std::string dateOfBirth, std::string address)
{
